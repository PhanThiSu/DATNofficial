    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview <?=($app['ctl']=='users')? 'active menu-open':'';?>">
        ...
        <ul class="treeview-menu">
          <li <?=($app['ctl']=='users' )? 'class="active"':'';?>><a href="<?=vendor_app_util::url(array('ctl'=>'users')); ?>"><i class="fa fa-users"></i> Danh sách người dùng</a></li>
          <li <?=($app['ctl']=='users' && $app['act']=='add')? 'class="active"':'';?>><a href="<?=vendor_app_util::url(array('ctl'=>'users', 'act'=>'add')); ?>"><i class="fa fa-user-plus"></i> Thêm người dùng</a></li>
        </ul>
      </li>
      ...
      <li class="treeview <?=($app['ctl']=='reports')? 'active menu-open':'';?>">
        <a href="#">
          ...
          <span>Quản lý báo cáo công việc</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          ...
          <li class="treeview <?=($app['ctl']=='reports' && ($app['act']=='month' || $app['act']=='week' || $app['act']=='daily'))? 'active menu-open':'';?>">
            <a href="#"><i class="fa fa-circle-o"></i> Danh sách báo cáo trong ...
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
      ...
      <li class="treeview <?=($app['ctl']=='requests')? 'active menu-open':'';?>">
        <a href="#">
          <i class="fa fa-exclamation-triangle"></i> <span>Quản lý phép</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview <?=($app['ctl']=='groups')? 'active menu-open':'';?>">
        <a href="#">
          <i class="fa fa-book"></i> <span>Quản lý nhóm làm việc</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          ...
          <li <?=($app['ctl']=='reports' && $app['act']=='usersgroups')? 'class="active"':'';?>><a href="<?=vendor_app_util::url(array('ctl'=>'reports', 'act'=>'usersgroups')); ?>"><i class="fa fa-list"></i> Tìm thành viên nhóm</a></li>
      ...
      <li class="treeview <?=($app['ctl']=='notifications')? 'active menu-open':'';?>">
        <a href="#">
          <i class="fa fa-envelope"></i> <span>Quản lý thông báo</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          ...
          <i class="fa fa-calendar"></i><span>Quản lý ngày kỷ niệm</span>
          </a>
        </li>
      <!-- <li>
