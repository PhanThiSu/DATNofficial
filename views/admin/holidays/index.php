...
<?php vendor_html_helper::contentheader('Quản lý ngày kỷ niệm', [['urlp'=>['ctl'=>$app['ctl'], 'act'=>$app['act']]]]); ?>
			    ...
			    <div class="box-header">
		    		<div class="row" id="records-header">
		    			<div class="col-sm-8 col-xs-6">
			      			<h2 class="box-title">Ngày kỷ niệm</h2>
		    			</div>
			    				...
			    				<table controller="holidays" class="table table-bordered table-striped dataTable" role = "grid" aria-describedby = "example1_info">
			    					<thead>
			    						<tr role="row">
			    							...
			    							<th class="" style="width:200px"  >Ngày</th>
											<th class="" style="width:auto" >Kỷ niệm</th>
									...
									<?php if(count($this->records['data'])) { ?>
						                ...
						                <!-- rowDATA -->
									<?php } else { ?>
										<tr role="row"><td colspan="8"><h3 class="text-danger text-center"> Dữ liệu rống </h3></td></tr>
						            <?php } ?>
			    					</tbody>
			    					<tfoot>
					                	<tr>
