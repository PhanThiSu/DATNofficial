	    			...
	    			<div class="col-sm-9 col-xs-9">
		      			<form id="form-report" action="<?php echo vendor_app_util::url(["ctl"=>"reports", "act"=>'usersgroups']); ?>" method="post" enctype="multipart/form-data" class="form-inline">
							<div class="form-group">
							    <label class="sr-only" for="exampleInputAmount">Chọn nhóm: </label>
							    <div class="input-group">
							      	<div class="input-group-addon mobileHide">Chọn nhóm: </div>
							...
							<button type="submit" class="btn btn-info" name="btn_submit">Tìm</button>
		      			</form>
	    			</div>
	    		</div>
		    	<!-- /.box-header -->
